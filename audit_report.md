...
#### 🟠 Modules "plats" — seul `commands/` existe dans chaque module
...
export class InsufficientFundsError extends AppError {
  constructor() { super("INSUFFICIENT_FUNDS", "Not enough coins"); }
}

export class CooldownError extends AppError {
  constructor(public readonly remaining: number, unit: "seconds" | "hours" = "seconds") {
    super("COOLDOWN", `On cooldown`, { remaining, unit });
  }
}

export class JobError extends AppError {
  constructor(code: "NOT_FOUND" | "ALREADY_HAVE" | "NO_JOB" | "REMOVED" | "INSUFFICIENT_EXP") {
...
export function createCommandHandler(
  handler: (interaction: ChatInputCommandInteraction, lang: string) => Promise<void>
) {
