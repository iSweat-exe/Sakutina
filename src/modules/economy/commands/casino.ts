import { ChatInputCommandInteraction, EmbedBuilder, MessageFlags, SlashCommandBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, ComponentType } from "discord.js";
    ...
    try {
      if (subcommand === "doubleornothing") {
        ...
        try {
          ...
          const choice = confirmation.customId.replace("rps_", "") as "rock" | "paper" | "scissors";
