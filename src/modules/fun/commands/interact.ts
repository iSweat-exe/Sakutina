...
const ACTIONS = [
    { name: 'hug', fr: 'calin', desc: 'Give someone a hug', frDesc: 'Faire un câlin à quelqu\'un' },
    { name: 'cuddle', fr: 'cuddle', desc: 'Cuddle with someone', frDesc: 'Faire un câlin tendre à quelqu\'un' },
    { name: 'sleep', fr: 'dormir', desc: 'Sleep with someone', frDesc: 'Dormir avec quelqu\'un' },
    { name: 'confused', fr: 'confus', desc: 'Be confused', frDesc: 'Être confus' },
    { name: 'blush', fr: 'rougir', desc: 'Blush at someone', frDesc: 'Rougir devant quelqu\'un' },
    { name: 'think', fr: 'reflechir', desc: 'Think deeply', frDesc: 'Réfléchir intensément' },
    { name: 'highfive', fr: 'highfive', desc: 'High-five someone', frDesc: 'Taper dans la main de quelqu\'un' },
    { name: 'bite', fr: 'mordre', desc: 'Bite someone', frDesc: 'Mordre quelqu\'un' },
    { name: 'shocked', fr: 'choque', desc: 'Be shocked', frDesc: 'Être choqué' },
    ...
    { name: 'pat', fr: 'pat', desc: 'Pat someone', frDesc: 'Faire des pat-pats à quelqu\'un' },
    { name: 'angry', fr: 'colere', desc: 'Be angry', frDesc: 'Être en colère' },
    { name: 'kiss', fr: 'bisou', desc: 'Kiss someone', frDesc: 'Faire un bisou' },
    { name: 'handshake', fr: 'poigneemain', desc: 'Shake hands', frDesc: 'Serrer la main' },
    { name: 'cry', fr: 'pleurer', desc: 'Cry', frDesc: 'Pleurer' },
    { name: 'lappillow', fr: 'genoux', desc: 'Give a lap pillow', frDesc: 'Prêter ses genoux' },
    { name: 'blowkiss', fr: 'bisouvolant', desc: 'Blow a kiss', frDesc: 'Envoyer un bisou volant' },
    { name: 'waifu', fr: 'waifu', desc: 'Claim as waifu', frDesc: 'Réclamer comme waifu' },
    { name: 'laugh', fr: 'rigoler', desc: 'Laugh', frDesc: 'Rigoler' },
    { name: 'thumbsup', fr: 'pouce', desc: 'Give a thumbs up', frDesc: 'Lever le pouce' },
    { name: 'shake', fr: 'secouer', desc: 'Shake someone', frDesc: 'Secouer quelqu\'un' },
...
async function getGif(type: string): Promise<GifData> {
    ...
    return { url: FALLBACK_GIFS[Math.floor(Math.random() * FALLBACK_GIFS.length)] as string };
}
...
const builder = new SlashCommandBuilder()
    ...
    .setDescriptionLocalizations({ fr: 'Interagir avec d\'autres utilisateurs' });
        ...
        sub
            ...
            .addUserOption((option) =>
                option
                    ...
                    .setDescriptionLocalizations({ fr: 'L\'utilisateur cible (optionnel)' })
                    .setRequired(false)
            )
    );
});
