...
const command: Command = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option
                ...
                .setDescriptionLocalizations({ fr: 'Le message à vous rappeler' })
                .setRequired(true)
        )
        .addIntegerOption((option) =>
            option
                ...
                .setDescriptionLocalizations({ fr: 'Durée avant le rappel (en minutes)' })
                .setRequired(true)
                .setMinValue(1)
    ...
    execute: createCommandHandler(async (interaction: ChatInputCommandInteraction, lang: string) => {
        ...
        const embed = EmbedUtils.success(msg, I18nService.translate('common:EMBED_TITLE_REMINDER_SET', { lng: lang }), interaction.user);
